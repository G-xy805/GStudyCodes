---
title: 模版类的作用
description: 详解C++类和结构体的特性和使用：模版类的作用
pubDate: 2025-01-19
...
由此可以看出函数模板和类模板之间的区别很简单，在template<class T>之后跟的是函数就是函数模板，跟的是类就是类模板。
...
![img](https://img-blog.csdnimg.cn/20200215190725115.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0RSX1NoYWRvdw==,size_16,color_FFFFFF,t_70)
...
![img](https://img-blog.csdnimg.cn/20200216114307738.png)
...
![img](https://img-blog.csdnimg.cn/20200216130045885.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L0RSX1NoYWRvdw==,size_16,color_FFFFFF,t_70)
