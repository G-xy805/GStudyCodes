---
title: "设计模式——观察者模式"
description: "观察者模式指多个对象间存在一对多的依赖关系，当一个对象的状态发生改变时，所有依赖于它的对象都得到通知并被自动更新。本文详细介绍了观察者模式的基本概念、优缺点、结构以及C++实现方式。"
pubDate: "2024-03-15"
image: "/assets/img/design-patterns/observer.webp"
categories: ["设计模式", "行为型模式"]
tags: ["观察者模式", "C++", "设计模式", "行为型模式", "发布-订阅"]
---
