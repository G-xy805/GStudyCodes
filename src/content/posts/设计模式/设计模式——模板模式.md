---
title: "设计模式——模板模式"
description: "模板方法模式定义一个操作中的算法骨架，而将算法的一些步骤延迟到子类中，使得子类可以不改变该算法结构的情况下重定义该算法的某些特定步骤。本文详细介绍了模板模式的基本概念、优缺点、结构以及C++实现方式。"
pubDate: "2024-03-15"
image: "/assets/img/design-patterns/template.webp"
categories: ["设计模式", "行为型模式"]
tags: ["模板模式", "C++", "设计模式", "行为型模式", "算法骨架"]
---
