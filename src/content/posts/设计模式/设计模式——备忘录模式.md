---
title: "设计模式——备忘录模式"
description: "备忘录模式在不破坏封装性的前提下，捕获一个对象的内部状态，并在该对象之外保存这个状态，以便以后当需要时能将该对象恢复到原先保存的状态。本文详细介绍了备忘录模式的基本概念、优缺点、结构以及C++实现方式。"
pubDate: "2024-03-15"
image: "/assets/img/design-patterns/memento.webp"
categories: ["设计模式", "行为型模式"]
tags: ["备忘录模式", "C++", "设计模式", "行为型模式", "状态保存"]
---
