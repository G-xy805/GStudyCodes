...
export const ja: Translation = {
	...
	[Key.noTags]: "タグなし",
	[Key.noCategory]: "カテゴリなし",
	[Key.categoryCount]: "カテゴリ",
	[Key.categoriesCount]: "カテゴリ",
	[Key.tagCount]: "タグ",
	[Key.tagsCount]: "タグ",
	...
	// アーカイブページ
	[Key.backToBlog]: "ブログに戻る",

	// カテゴリー詳細ページ
	[Key.allCategories]: "すべてのカテゴリー",
	[Key.browseAllPostsInCategory]: "このカテゴリーのすべての投稿を閲覧",
	[Key.noPostsInCategory]: "このカテゴリーに投稿はありません",
