---
title: "设计模式——策略模式"
description: "策略模式定义了一系列算法，并将每个算法封装起来，使它们可以相互替换，且算法的变化不会影响使用算法的客户。本文详细介绍了策略模式的基本概念、优缺点、结构以及C++实现方式。"
pubDate: "2024-03-15"
image: "/assets/img/design-patterns/strategy.webp"
categories: ["设计模式", "行为型模式"]
tags: ["策略模式", "C++", "设计模式", "行为型模式", "算法封装"]
---
...
int main() {
    Context context;
    auto strategy = std::make_shared<ConcreteStrategyA>();
